...
/**
 * Email Configuration Test Script (CommonJS)
 * 
 * This script tests your email configuration to ensure emails can be sent.
 * Run it with: node scripts/test-email.cjs
 */

const { testEmailConnection } = require('../lib/email-service')
const { validateEmailConfig, getProviderEnvVars } = require('../lib/email-config')
