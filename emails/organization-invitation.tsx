      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              MindFlow is a powerful learning management system that helps
              organizations create, manage, and deliver engaging educational
              content.
            </Text>

            <Text style={text}>
              Click the button below to accept this invitation and create your
              account. You'll be able to set up your password and start using
              MindFlow right away.
            </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This invitation was sent by MindFlow. If you didn't expect this
