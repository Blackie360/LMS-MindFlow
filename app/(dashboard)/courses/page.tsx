...
// Static course data to avoid server-side operations
const courses = [
  {
    id: "1",
    ...
    instructor: { full_name: "John Doe", id: "instructor-1" },
  ...
  },
  {
    ...
    cover_image: "/placeholder.svg?height=200&width=300",
    instructor: { full_name: "Jane Smith", id: "instructor-2" },
    category: { name: "Programming", id: "cat-2" },
    price: 149.99,
    status: "published",
  ...
  },
  {
    ...
    cover_image: "/placeholder.svg?height=200&width=300",
    instructor: { full_name: "Mike Johnson", id: "instructor-3" },
    category: { name: "Design", id: "cat-3" },
    price: 79.99,
    status: "published",
  ...
  },
  {
    ...
    cover_image: "/placeholder.svg?height=200&width=300",
    instructor: { full_name: "Sarah Wilson", id: "instructor-4" },
    category: { name: "Data Science", id: "cat-4" },
    price: 129.99,
    status: "published",
    created_at: "2024-01-08T08:00:00Z",
    enrollments: [{ count: 134 }],
    lessons: [{ count: 20 }],
    rating: 4.6,
    duration: "15 hours",
  },
